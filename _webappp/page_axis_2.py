...
st.header("Where do occupations appear and how frequent are they?")
...
def plot_html(path, height=650):
    ...
    st.components.v1.html(
        ...
        /* Force everything to obey container width */
        * {{
...
st.header("Are some categories of occupations funnier than others?")
"""
...
def plot_html1(path, height=6000):
    with open(path, "r", encoding="utf-8") as f:
        html = f.read()
    ...
    st.components.v1.html(
        f"""
        <style>
        /* Kill any fixed width inside the HTML */
        html, body {{
            margin: 0 !important;
            padding: 0 !important;
            width: 10% !important;
        ...
        * {{
        ...
        <div style="width:1%; max-width:1; overflow:hidden;">
            {html}
        </div>
        """,
        height=height,
...
st.header("Themes Across Captions")
...
st.header("Do we appriciate the work of other people?")
"""
